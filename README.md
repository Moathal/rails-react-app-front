...
> Project of implementation React as front-end and connect Rails as API.
...
```sh
  ...
  git clone https://github.com/moathal/rails-react-app-front
```
...
- **How I can run this project?**
  ...
  - After cloning repository, run npm run start. After that, you will see you will see the homepage of the project.
